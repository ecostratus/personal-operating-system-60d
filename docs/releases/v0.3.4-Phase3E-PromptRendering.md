...
This release activates the first Phase 3E milestone by connecting deterministic enrichment to prompt rendering for outreach and resume tailoring. Enriched job fields (seniority, domain_tags, stack, skills) are now passed into structured templates, enabling richer, more context-aware prompts without sacrificing determinism.
