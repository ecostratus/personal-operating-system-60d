...
### Optional: Target Role (if outreach is about a role)
**Role Title**: {{target_role_title}}
**Company**: {{target_role_company}}
**Link**: {{target_role_url}}

### Optional: Enriched Role Context (if available)
**Seniority**: {{seniority}}
...
If enriched role context is provided, incorporate relevant items (seniority, domain_tags, stack, skills) to make the message concrete and aligned to the recipients interests or the target role. Do not force inclusion; only use items that naturally strengthen specificity.
...
[Explain the specific personalization elements used and why they're relevant]
 - If enriched role context was provided, list which elements were used (e.g., seniority, domain_tags like "backend" and "ml", stack items like "Python", "Kubernetes", or CI/CD tools) and why they made the outreach more specific.
